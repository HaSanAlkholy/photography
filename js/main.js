...
let heart =document.getElementById('heart-like');

heart.addEventListener('click',e => {
    heart.style.animation = "heartBeat2 0.001s linear infinite alternate";
    ...
    setTimeout(e => {
        heart.style.animation = "heartBeat1 0.7s linear infinite alternate";
